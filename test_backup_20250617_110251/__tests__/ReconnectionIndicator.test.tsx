...
describe('ReconnectionIndicator', () => {
  ...
  it('renders connecting indicator correctly', () => {
    ...
    const spinningIcon = screen.getByRole('img', { hidden: true });
  ...
  it('renders reconnecting indicator correctly', () => {
    ...
    // Check for pulsing icon
    const pulsingIcon = screen.getByRole('img', { hidden: true });
    expect(pulsingIcon).toHaveClass('animate-pulse');
  ...
  it('renders error indicator correctly', () => {
    ...
    expect(errorIcon).not.toHaveClass('animate-spin');
    expect(errorIcon).not.toHaveClass('animate-pulse');
  ...
  it('renders different SVG icons for different statuses', () => {
    ...
    // Icons should be different (though we can't easily test exact SVG content)
