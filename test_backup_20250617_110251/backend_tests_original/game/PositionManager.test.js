...
describe('PositionManager', () => {
    let positionManager;
    beforeEach(() => {
        positionManager = new PositionManager_1.PositionManager(10, 20); // Small blind: 10, Big blind: 20
    });
    ...
    describe('Utility methods', () => {
        ...
        test('should detect invalid state', () => {
            ...
            positionManager.players = ['player1']; // Single player is invalid
            expect(positionManager.validateState()).toBe(false);
        });
        test('should copy state from another PositionManager', () => {
            const other = new PositionManager_1.PositionManager(5, 10);
