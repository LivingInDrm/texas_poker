...
describe('WebSocket Room Handlers Tests', () => {
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        clientSocket = new socket_io_client_1.default(`http://localhost:3001`, {
            auth: {
                token: 'valid-token'
            }
        });
    ...
    describe('Player notifications', () => {
        ...
        beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            secondClient = new socket_io_client_1.default(`http://localhost:3001`, {
    ...
    describe('Authentication', () => {
        it('should reject connections with invalid tokens', (done) => {
            const invalidClient = new socket_io_client_1.default(`http://localhost:3001`, {
        ...
        it('should reject connections without tokens', (done) => {
            const noTokenClient = new socket_io_client_1.default(`http://localhost:3001`);
